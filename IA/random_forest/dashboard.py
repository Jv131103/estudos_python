...
st.set_page_config(
    page_title="Dashboard Random Forest",
    layout="wide"
)

st.title("Dashboard de Machine Learning — Random Forest")
...
st.write("Quantidade de árvores:", n_estimators)
st.write("Profundidade máxima:", max_depth)
...
# =========================
st.header("6. Importância das Features")
...
ax_imp.bar(importancias["feature"], importancias["importancia"])
...
participacao_nova = st.number_input(
    "Participação:",
    min_value=0.0,
    max_value=10.0,
    value=8.0,
...
media_atividades_nova = st.number_input(
