"""
Considere a lista de produtos abaixo e implemente duas soluções para somar o
valor total deste carrinho de compras.
...
total = sum([produto['preco'] for produto in lista_compras])
print(f"Total: {total:.2f}")
