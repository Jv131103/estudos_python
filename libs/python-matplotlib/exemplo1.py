...
# Gráfico de linhas
# Os gráficos de linha são ferramentas adequadas para visualizar
# a evolução de dados ao longo do tempo, permitindo identificar
# tendências e padrões com clareza.
